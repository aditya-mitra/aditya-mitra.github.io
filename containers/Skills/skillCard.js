...
import { handleMouseMove, handleMouseLeave } from './skillMouseMovements';
	...
	return (
		<>
			...
			<div
				...
				id={`skillcard-${id}`}
				ref={containerRef}
				onMouseMove={(event) => handleMouseMove(event, containerRef.current)}
