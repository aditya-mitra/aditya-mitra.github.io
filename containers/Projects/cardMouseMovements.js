 ...
 * @param {Function} displayCard
 */
export function handleDrag(event, uniqueMark, totalItems, currentItem, displayCard) {
	if (willDrag) {
 ...
 * @param {Function} displayCard
 */
export function handleTouchEnd(event, uniqueMark, totalItems, currentItem, displayCard) {
